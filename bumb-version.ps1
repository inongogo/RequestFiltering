...
#######################################################################
# Settings - must be set for each project
# All projects in the solution must start with the packagePrefix...e.g.
# Starter.Tests, Starter.Common, Starter.Data, etc
#

# The current version will be read from this file
$projectFile = "src\RequestFiltering\project.json"

# All projects and dependencies starting with this name will be updated.
$packagePrefix = "RequestFiltering"
